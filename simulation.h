...
public:
    ...
    /**
     * @brief printGameState Print the game state by printing the map to console, used for debugging.
     */
    void printGameState();
...
signals:
    ...
    /**
     * @brief runningBlock Singal notify machinegraph that running block has changed, so it can update the graph.
     */
